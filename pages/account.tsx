...
export default function Account(): JSX.Element {
  ...
  return (
    ...
    >
      {/* main image */}
      <div className="border  border-solid border-slate-100  bg-white rounded-3xl shadow-md">
        <img
          src="img.jpeg"
          alt={data?.name}
          height={300}
        ...
        <div className="max-w-[47rem] mx-auto flex flex-col  justify-start  w-full ">
          {/* main text */}
          <div className="flex items-start justify-start w-full  ">
            <img
              ...
              width={130}
              height={130}
              className="rounded-full shadow-2xl relative -top-10 border-4 border-solid border-white  "
            />
            <div className="flex flex-col items-start justify-between  pl-5 ">
              <ThemedText className="text-3xl  pt-4 capitalize font-medium">{`${data?.name} ${data?.family}`}</ThemedText>
      ...
      {data && data?.bio.length > 0 && (
        <div className=" flex flex-col w-full h-96 items-center justify-start rounded-3xl border border-solid border-slate-100  shadow-md bg-white">
          <div className="max-w-[47rem] py-7">
