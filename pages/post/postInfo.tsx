  ...
  return (
    <>
      <Layout>
          ...
          {showInfo && (
            <Note>
              <div className="p-5 flex flex-col justify-between">
                ...
                family={adminInfo?.family}
                image={adminInfo?.image}
                textinfo="text-lg capitalize font-medium"
                key={adminInfo?.id}
              /> */}
              </div>
            </Note>
        ...
        <h1 className="capitalize m-0 w-full cursor-pointer">{data?.title}</h1>
        ...
        <ThemedText className="text-xl pt-10 w-full leading-8">
          {data?.content}
        </ThemedText>
      </Layout>
    </>
